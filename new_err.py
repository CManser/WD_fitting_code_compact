...
def err_t(x,rv,valore,spec,lcrop,models='da2014'):
    """Script finds errors by minimising function at chi+1 rather than chi
       ...
       spec - spectrum to fit
       linee - list of cropped lines to fit """
    tmp = tmp_func(x[0], x[1], rv, spec, lcrop, models)
