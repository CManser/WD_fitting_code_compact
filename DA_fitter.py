...
new_best=optimize.fmin(new_err.fit_func_test,(first_T,first_g,10.),args=(spectra,line_crop,model_c,0),disp=0,xtol=1.,ftol=1.,full_output=1)
other_T=optimize.fmin(new_err.err_t,(first_T,first_g),args=(new_best[0][2],new_best[1],spectra,line_crop,model_c),disp=0,xtol=1.,ftol=1.,full_output=0)
